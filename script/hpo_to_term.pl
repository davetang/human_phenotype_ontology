...
use strict;
use warnings;
use hpo qw/hpo_to_name hpo_to_level hpo_to_synonym hpo_to_disease hpo_to_gene/;
...
foreach my $h (@ARGV){
   ...
   my $gene_number = hpo_to_gene($h);
   print "$h\tlevel: $level\tdisease associations: $disease_number\tgene associations: $gene_number\n";
   print "\t$name\n";
